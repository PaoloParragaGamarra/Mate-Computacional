...
label_n = tk.Label(root, text="Ingrese la cantidad de vertices '5,15':")
label_n.pack()
...
resolver_button = tk.Button(root, text="Agente Viajero", command=resolver_tsp)
resolver_button.pack()

result_label = tk.Label(root, text="", wraplength=300)
result_label.pack()

cerrar_button = tk.Button(root, text="Cerrar Programa", command=cerrar_programa, bg="red", fg="white")
cerrar_button.pack()
